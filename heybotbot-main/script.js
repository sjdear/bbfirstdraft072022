...
function random() {
    let thirdMessage = 'PLACEHOLDER FOR RANDOM'
    let time = getTime();
...
function argTwoMessage() {
    ...
    document.getElementById("chat-bar-bottom").scrollIntoView(true);
    document.getElementById("helloButton").innerHTML = "Maybe just not telling me I’m (RANDOM) would help?";
    ...
    function telling (){
        buttonDisappearOne();
            let userText = 'you: Maybe just not telling me I’m (answer they were given) would help?'
            let time = getTime();
            let botHtml = '<p class="botText"><span>' + time + userText + '</span></p>';
            $("#chatbox").append(botHtml);
